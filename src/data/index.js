...
export const PHONICS_ITEMS = [
  ...
  { letter: 'B', word: 'Ball', emoji: '⚽️', sound: 'b' },
  { letter: 'C', word: 'Cat', emoji: '🐱', sound: 'c' },
  { letter: 'D', word: 'Dog', emoji: '🐶', sound: 'd' },
  { letter: 'E', word: 'Elephant', emoji: '🐘', sound: 'e' },
  ...
  { letter: 'O', word: 'Octopus', emoji: '🐙', sound: 'o' },
  { letter: 'P', word: 'Pizza', emoji: '🍕', sound: 'p' },
  { letter: 'Q', word: 'Queen', emoji: '👑', sound: 'qu' },
  { letter: 'R', word: 'Rocket', emoji: '🚀', sound: 'r' },
  { letter: 'S', word: 'Sun', emoji: '☀️', sound: 's' },
  { letter: 'T', word: 'Tiger', emoji: '🐯', sound: 't' },
  { letter: 'U', word: 'Umbrella', emoji: '☂️', sound: 'u' },
  { letter: 'V', word: 'Violin', emoji: '🎻', sound: 'v' },
  { letter: 'W', word: 'Whale', emoji: '🐳', sound: 'w' },
  { letter: 'X', word: 'Fox', emoji: '🦊', sound: 'x' },
  { letter: 'Y', word: 'Yo-yo', emoji: '🪀', sound: 'y' },
...
export const GAME_LABELS = {
  ...
  worldmap: 'Curriculum Quest',
  'worldmap-continents': 'Curriculum Quest: Geography',
  'worldmap-time-detectives': 'Curriculum Quest: History',
  'worldmap-nature-lab': 'Curriculum Quest: Science',
